...
import ru.NIKITOS_V.Formating.MessageData;
import ru.NIKITOS_V.Formating.Save;
import ru.NIKITOS_V.JavaInterfaces.BaseServer;
...
import ru.NIKITOS_V.Writers.ClassSaver;
import ru.NIKITOS_V.Writers.Logger;
...
public class Server implements CCDController, BaseServer {
    ...
    private RecipientMessages binder;
    ...
    @Override
    public void setBinder(RecipientMessages binder) {
        this.binder = binder;
